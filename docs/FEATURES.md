...
Statuts : [ ] à faire · [en cours] en cours · [fait] fait

## Phase 0 — Fondations [fait]
- [fait] Scaffold Next.js 15 + TS + Tailwind
- [fait] Schéma Supabase (tables `jp_*` + RLS) appliqué
- [fait] Clients Supabase (browser / server / middleware)
